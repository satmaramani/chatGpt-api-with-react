...
import { sample_questions_explain_code } from '../Constants';
...
function ExplainCode() {
  ...
  useEffect(()=>{
    const sample_question_temp = <div>
        <HeadingDisplay title="Code Explainer"/>

      {sample_questions_explain_code.map((item, index) => (
    <div key={index}>
  ...
  const promptValTranslate = ` explain this code : ${promptVal}`;
